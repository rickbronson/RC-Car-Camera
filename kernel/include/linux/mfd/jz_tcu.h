...
/* struct to send to /sys/devices/platform/jz-tcu/cmd */
struct tx2_setup {
	int command;
};
...
struct jz_tcu {
	...
	int tx2_flags;
#define TX2_FLAGS_INIT 1
	int tx2_int_cntr;
#define TX2_START_CODE_MAX 4  /* each start code is 4 x 500us long */
#define TX2_MAX_SEQ 64  /* each seq code is 2 x 500us long */
	char tx2_seq[TX2_START_CODE_MAX * 4 + TX2_MAX_SEQ * 2];
	int tx2_seq_cntr;
	int tx2_seq_max;
